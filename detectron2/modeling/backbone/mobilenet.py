...
class MobileNetV2(Backbone):
    ...
    def forward(self, x):
        ...
        res_dic = {'res{}'.format(i + 2): r for i, r in enumerate(res)}
        # del res_dic['res5']

        # print({'res{}'.format(i + 2): r for i, r in enumerate(res)})
        return res_dic
...
def build_mnv2_backbone(cfg, input_shape):
    ...
    # out_feature_channels = {"res2": 24, "res3": 32, "res4": 96}
    # out_feature_strides = {"res2": 4, "res3": 8, "res4": 16}
